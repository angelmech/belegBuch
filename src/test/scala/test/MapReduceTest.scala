...
class MapReduceTest extends AnyFunSuite:
  ...
  */
  ...
  val data: List[(String,String,String,Int)] =List(("2020.05.08 AD at 10:05:12 PDT","meier","wordcount",20),("2020.05.08 AD at 12:05:12 PDT","weber","apachelog",50),
    ("2020.05.08 AD at 13:06:17 PDT","meier","wordcount",15),("2020.05.08 AD at 15:25:17 PDT","meier","wordcount",25),
  ("2020.05.09 AD at 12:00:12 PDT","weber","apachelog",45),("2020.05.09 AD at 14:17:22 PDT","meier","wordcount",21),
  ("2020.05.09 AD at 18:15:17 PDT","weber","apachelog",20),("2020.05.09 AD at 20:05:12 PDT","meier","wordcount",17),
  ("2020.05.10 AD at 09:22:33 PDT","mueller","MeineAnalyse",100),("2020.05.10 AD at 12:07:02 PDT","meier","TF-IDF",2000),
    ("2020.05.10 AD at 12:35:02 PDT","mueller","TF-IDF",2100))
